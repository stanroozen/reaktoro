...
try:
    ...
    # Script is 3 levels deep: reaktoro/DEW_Experimental_Benchmark/Mineral_Solubilities/corundum/
    _d0 = os.path.dirname(os.path.abspath(__file__))  # corundum/
...
# Script is 3 levels deep: reaktoro/DEW_Experimental_Benchmark/Mineral_Solubilities/corundum/
_CORUNDUM_DIR = SCRIPT_DIR
_MINERAL_SOL_DIR = os.path.dirname(_CORUNDUM_DIR)
...
MINERAL_CONFIG = {
    ...
    "mineral_name": "Corundum",  # Name in database
    "mineral_formula": "Al2O3",  # Chemical formula
    "target_element": "Al",  # Element to report total dissolved molality
    "solute_species": "Al+3(aq)",  # Primary aqueous species
    # Aqueous species to include (besides water, H+, OH-)
    "include_elements": ["Al", "O", "H"],
    "aqueous_species": "",
    # File paths
    "csv_file": "corundum_DEW_testset.csv",
    "output_prefix": "corundum",  # Prefix for output files
    # Plot settings
    "plot_title": "Corundum Solubility",
    "y_label": "Corundum Solubility (mol/kg-Hâ‚‚O)",
}
# ============================================================
