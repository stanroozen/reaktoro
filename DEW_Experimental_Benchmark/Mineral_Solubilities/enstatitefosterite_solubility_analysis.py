...
MINERAL_CONFIG = {
    ...
    "y_label": "Apparent Enstatitefosterite Solubility (m_Si from Enstatite+Forsterite, mol/kg-Hâ‚‚O)",
}
# ============================================================
...
def main():
    ...
    if not os.path.exists(CSV_FILE):
        ...
        if len(exp_data) > 0:
            ...
            print(
                f"    Experimental molality range: {exp_data['molality_m'].min():.3g} - {exp_data['molality_m'].max():.3g} mol/kg-Hâ‚‚O"
            )
