...
MINERAL_CONFIG = {
    ...
    # element filter is used and returns: H2O(aq) H+(aq) OH-(aq) CO2(aq) HCO3-(aq) CO3-2(aq)
    # H2CO3 CaCO3(aq) Ca(HCO3)+(aq) Ca(OH)+(aq) Ca+2(aq))
    "aqueous_species": "CO2(aq) HCO3-(aq) CO3-2(aq) H2CO3 CaCO3(aq) Ca(HCO3)+(aq) Ca(OH)+(aq)",
    # File paths
