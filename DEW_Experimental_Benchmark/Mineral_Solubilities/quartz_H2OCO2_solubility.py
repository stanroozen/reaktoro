...
MINERAL_CONFIG = {
    ...
    "aqueous_species": "HSiO3- Si2O4_aq Si3O6_aq",
...
def compute_activity_corrected_curve(m0_dict, aH2O_array, xco2_array):
    ...
    Parameters
    ----------
    m0_dict    : dict with keys 'SiO2_aq', 'HSiO3-', 'Si2O4_aq', 'Si3O6_aq'
    ...
    """
    m0_sio2 = float(m0_dict.get("SiO2_aq", 0.0))
    m0_hsi = float(m0_dict.get("HSiO3-", 0.0))
    m0_si2 = float(m0_dict.get("Si2O4_aq", 0.0))
    m0_si3 = float(m0_dict.get("Si3O6_aq", 0.0))
...
def main():
    ...
    for P_kbar in MODEL_PRESSURES_KBAR:
        ...
        print(
            f"      mâ‚€(SiO2_aq)={m0['SiO2_aq']:.4f}  mâ‚€(Si2O4_aq)={m0['Si2O4_aq']:.4f}  "
            f"mâ‚€(Si3O6_aq)={m0['Si3O6_aq']:.4e}  mâ‚€(HSiO3-)={m0['HSiO3-']:.4e}  "
