...
OUTPUT_PLOT_LOW = os.path.join(SCRIPT_DIR, "quartz_solubility_comparison_low_P.png")
OUTPUT_PLOT_HIGH = os.path.join(SCRIPT_DIR, "quartz_solubility_comparison_high_P.png")
RESIDUALS_PLOT = os.path.join(SCRIPT_DIR, "quartz_solubility_residuals.png")
...
def main():
    ...
    info_text = "DEW19 (species) + SUPCRTBL (quartz) + Zhang-Duan 2005 EOS (Hâ‚‚O)"
    ax1.text(
        0.02,
        0.98,
        info_text,
