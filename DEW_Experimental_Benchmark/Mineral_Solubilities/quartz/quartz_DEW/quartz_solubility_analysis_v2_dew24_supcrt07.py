"""
Quartz Solubility Analysis using Reaktoro with DEW2024 + SUPCRT07
...
OUTPUT_PLOT_LOW = os.path.join(
    SCRIPT_DIR, "quartz_solubility_comparison_low_P_dew24_supcrt07.png"
)
OUTPUT_PLOT_HIGH = os.path.join(
    SCRIPT_DIR, "quartz_solubility_comparison_high_P_dew24_supcrt07.png"
)
RESIDUALS_PLOT = os.path.join(
    SCRIPT_DIR, "quartz_solubility_residuals_dew24_supcrt07.png"
)
...
def main():
    print("=" * 80)
    print("Quartz Solubility Analysis - Reaktoro DEW2024 + SUPCRT07")
    print("=" * 80)
    ...
    try:
        ...
        print("    Successfully loaded DEW2024 + SUPCRT07 aqueous database")
    except Exception as e:
    ...
    info_text = "DEW24 (species) + SUPCRT07 (quartz) + Zhang-Duan 2005 EOS (Hâ‚‚O)"
    ax1.text(
        0.02,
        0.98,
        info_text,
