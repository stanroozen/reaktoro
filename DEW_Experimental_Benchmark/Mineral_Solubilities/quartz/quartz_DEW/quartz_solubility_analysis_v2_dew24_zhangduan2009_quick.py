"""
Quartz Solubility Analysis using Reaktoro with DEW2024 + ZhangDuan2009 water EOS
...
OUTPUT_PLOT_LOW = os.path.join(
    SCRIPT_DIR, "quartz_solubility_comparison_low_P_dew24_zhangduan2009.png"
)
OUTPUT_PLOT_HIGH = os.path.join(
    SCRIPT_DIR, "quartz_solubility_comparison_high_P_dew24_zhangduan2009.png"
)
RESIDUALS_PLOT = os.path.join(
    SCRIPT_DIR, "quartz_solubility_residuals_dew24_zhangduan2009.png"
)
...
def build_system(dew_db, supcrt_db, water_config=None):
    ...
    try:
        ...
        params.waterOptions.eosModel = eos_map.get(
            water_config.get("eos_model", "ZhangDuan2009"), WaterEosModel.ZhangDuan2009
        )
        ...
        eos_name = water_config.get("eos_model", "ZhangDuan2009")
...
def main():
    print("=" * 80)
    print("Quartz Solubility Analysis - Reaktoro DEW2024 + ZhangDuan2009 EOS")
    print("=" * 80)
    ...
    info_text = "DEW24 (species) + SUPCRTBL (quartz) + Zhang-Duan 2009 EOS (Hâ‚‚O)"
    ax1.text(
        0.02,
        0.98,
        info_text,
