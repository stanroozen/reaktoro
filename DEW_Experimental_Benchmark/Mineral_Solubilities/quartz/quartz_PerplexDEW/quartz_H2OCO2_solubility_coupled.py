...
HYDRATION = {"SiO2(aq)": 2, "HSiO3-(aq)": 1, "Si2O4(aq)": 4, "Si3O6(aq)": 6}
...
def build_dew_system(dew_db, supcrt_db, dh_model="ExtendedDH"):
    ...
    aq_str = "H2O(aq) H+(aq) OH-(aq) SiO2(aq) HSiO3-(aq) Si2O4(aq) Si3O6(aq)"
...
def solve_dew_baseline(dew_system, T_C, P_bar):
    ...
    print(
        f"      m0(SiO2_aq)={m0['SiO2(aq)']:.4f}  m0(HSiO3-)={m0['HSiO3-(aq)']:.5f}"
        f"  m0(Si2O4)={m0['Si2O4(aq)']:.5f}  total_Si={m_total:.4f} mol/kg"
    )
    return m0
