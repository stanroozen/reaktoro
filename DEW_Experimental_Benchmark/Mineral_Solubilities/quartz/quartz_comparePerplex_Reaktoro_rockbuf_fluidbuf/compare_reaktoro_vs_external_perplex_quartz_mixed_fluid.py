"""
Direct Perple_X vs PerplexDEW mixed-fluid parity checks for quartz.
...
OUTPUT_CSV = SCRIPT_DIR / "perplex_quartz_mixed_fluid_parity_results.csv"
...
def parse_perplex_prn(
    ...
    # are in each species (e.g., for Quartz tracking Si: SiO2 has 1 Si, HSiO3- has 1 Si, etc.)
    total = 0.0
    for species, coeff in cfg["element_coeffs"].items():
