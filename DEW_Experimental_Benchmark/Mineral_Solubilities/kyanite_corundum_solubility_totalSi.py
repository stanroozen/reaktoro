...
MINERAL_CONFIG = {
    ...
    # File paths
    "csv_file": "kyanite_corundum_DEW_testset_totalSi.csv",
    "output_prefix": "corundum_kyanite_totalSi",  # Prefix for output files
    # Plot settings
    "plot_title": "Corundum + Kyanite Solubility (Si)",
    "y_label": "Total Si molality (mol/kg-Hâ‚‚O)",
}
# ============================================================
