...
CASES: tuple[RegressionCase, ...] = (
    ...
    RegressionCase("test_build_system", "test_build_system.py", ("smoke", "core"), 300),
    RegressionCase(
        "test_dew_water_models", "test_dew_water_models.py", ("smoke", "water"), 300
    ),
    RegressionCase("test_h2o_aq_dew", "test_h2o_aq_dew.py", ("smoke", "water"), 300),
    RegressionCase("test_h2o_dummy", "test_h2o_dummy.py", ("smoke", "water"), 300),
    RegressionCase(
        "test_perplex_conditions_nosilence",
        "test_perplex_conditions_nosilence.py",
        ("smoke", "perplexdew"),
        300,
    ),
    # Quartz backend runs
    RegressionCase(
        "run_quartz_dew", "run_quartz_DEW.py", ("regression", "quartz", "dew"), 900
    ),
    RegressionCase(
        "run_quartz_perplexdew",
        "run_quartz_PerplexDEW.py",
        ("regression", "quartz", "perplexdew"),
        1200,
    ),
    RegressionCase(
        "run_quartz_perplexdew_extendeddh",
        "run_quartz_PerplexDEW_ExtendedDH.py",
        ("regression", "quartz", "perplexdew"),
        1200,
    ),
    # Mineral solubility backend runs
    RegressionCase(
        "run_calcite_dew",
        "Mineral_Solubilities/run_calcite_DEW.py",
        ("regression", "calcite", "dew"),
        1200,
    ),
    RegressionCase(
        "run_calcite_dew_co2aq",
        "Mineral_Solubilities/run_calcite_DEW_CO2aq.py",
        ("regression", "calcite", "dew", "h2oco2"),
        1200,
    ),
    RegressionCase(
        "run_calcite_perplexdew_davies",
        "Mineral_Solubilities/run_calcite_PerplexDEW_Davies.py",
        ("regression", "calcite", "perplexdew"),
        1200,
    ),
    RegressionCase(
        "run_calcite_perplexdew_extendeddh",
        "Mineral_Solubilities/run_calcite_PerplexDEW_ExtendedDH.py",
        ("regression", "calcite", "perplexdew"),
        1200,
    ),
    RegressionCase(
        "run_calcite_perplexdew_davies_h2oco2",
        "Mineral_Solubilities/run_calcite_PerplexDEW_Davies_H2OCO2.py",
        ("regression", "calcite", "perplexdew", "h2oco2"),
        1200,
    ),
    RegressionCase(
        "run_calcite_perplexdew_extendeddh_h2oco2",
        "Mineral_Solubilities/run_calcite_PerplexDEW_ExtendedDH_H2OCO2.py",
        ("regression", "calcite", "perplexdew", "h2oco2"),
        1200,
    ),
    RegressionCase(
        "run_quartz_perplexdew_davies_h2oco2",
        "Mineral_Solubilities/run_quartz_PerplexDEW_Davies_H2OCO2.py",
        ("regression", "quartz", "perplexdew", "h2oco2"),
        1200,
    ),
    RegressionCase(
        "run_quartz_perplexdew_extendeddh_h2oco2",
        "Mineral_Solubilities/run_quartz_PerplexDEW_ExtendedDH_H2OCO2.py",
        ("regression", "quartz", "perplexdew", "h2oco2"),
        1200,
    ),
    # Parity workflows
    RegressionCase(
        "quartz_h2oco2_parity_check",
        "Mineral_Solubilities/quartz_H2OCO2_parity_check.py",
        ("parity", "regression", "quartz", "h2oco2", "perplexdew"),
        1200,
    ),
    RegressionCase(
        "quartz_h2oco2_parity_check_nondeps",
        "Mineral_Solubilities/quartz_H2OCO2_parity_check_nondeps.py",
        ("parity", "regression", "quartz", "h2oco2", "perplexdew", "smoke"),
        900,
    ),
    RegressionCase(
        "perplex_mixed_fluid_parity",
        "Mineral_Solubilities/perplex_mixed_fluid_parity.py",
        (
            "parity",
            "regression",
            "calcite",
