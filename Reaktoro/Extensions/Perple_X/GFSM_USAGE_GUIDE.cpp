...
// Example: Using Perple_X GFSM model in Reaktoro
// ================================================
//
...
// ============================================================================
//
// GFSM requires user to specify mole fractions of all 13 fluid species:
...
// ============================================================================
//
// Use StandardThermoModelPerplexGFSM when you need reference state properties
// for individual species. This returns a callable StandardThermoModel.
...
// ============================================================================
//
// These are exposed through PerpleXPureEos.hpp and allow direct computation
// of ln(fugacity) and molar volume for pure species at any P-T point.
//
// Available functions:
// - hsmrkf():   HSMRK EOS (H2O, CO2, CH4)
// - crkH2O():   CORK EOS (H2O only)
// - crkCO2():   CORK EOS (CO2 only)
// - pseos():    PSEOS (H2O, CO2)
// - brmrk():    BRMRK (H2O, CO2)
...
auto Example_PureEOS()
{
    ...
    // Example: Evaluate H2O using HSMRK
    {
        ...
        // ln_fugacity is the ln(fugacity coefficient)
    }
    ...
    // Example: Using hybrid EOS selector to switch between alternatives
    {
        ...
        // options.waterEos can be set to: MRK, HSMRK, CORK, PSEOS, HAAR, ZDHH2O, ZD09
        // options.co2Eos can be set to: MRK, HSMRK, CORK, BRMRK, PSEOS, ZD09
        // options.ch4Eos can be set to: MRK, HSMRK, ZD09
...
// ============================================================================
// Comparison: Using All Three Interfaces Together
// ============================================================================
//
// A complete workflow combining GFSM model with individual EOS evaluation:

auto Example_Complete_Workflow()
{
    // Part A: Setup GFSM mixture
    Reaktoro::SpeciesList species;  // 13 species
    // ... populate species ...
...
//    - Each species evaluated independently at pure-species level
//    - Then combined without mixing law
//
...
//
// 4. Unit conventions:
//    - Reaktoro: Pa, Kelvin, J/mol, m³/mol
//    - Perple_X internal: bar, Kelvin, cm³/mol
//    - Conversions handled internally by wrapper functions
//
// ============================================================================
