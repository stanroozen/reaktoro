...
void exportChemicalState(py::module& m)
{
    py::class_<ChemicalState>(m, "ChemicalState")
        ...
        .def("setTemperature", [](ChemicalState& self, double val) { self.setTemperature(val); })
        .def("setTemperature", py::overload_cast<real const&>(&ChemicalState::setTemperature))
        .def("setTemperature", [](ChemicalState& self, double val, Chars unit) { self.setTemperature(val, unit); })
        .def("setTemperature", py::overload_cast<real, Chars>(&ChemicalState::setTemperature))
        .def("temperature", [](ChemicalState& self, double val) { self.temperature(val); })
        .def("temperature", py::overload_cast<real const&>(&ChemicalState::temperature))
        .def("temperature", [](ChemicalState& self, double val, Chars unit) { self.temperature(val, unit); })
        ...
        .def("setPressure", [](ChemicalState& self, double val) { self.setPressure(val); })
        .def("setPressure", py::overload_cast<real const&>(&ChemicalState::setPressure))
        .def("setPressure", [](ChemicalState& self, double val, Chars unit) { self.setPressure(val, unit); })
        .def("setPressure", py::overload_cast<real, Chars>(&ChemicalState::setPressure))
        .def("pressure", [](ChemicalState& self, double val) { self.pressure(val); })
        .def("pressure", py::overload_cast<real const&>(&ChemicalState::pressure))
        .def("pressure", [](ChemicalState& self, double val, Chars unit) { self.pressure(val, unit); })
        ...
        .def("setSpeciesAmount", [](ChemicalState& self, Index idx, double amount) { self.setSpeciesAmount(idx, amount); })
        .def("setSpeciesAmount", py::overload_cast<Index, real const&>(&ChemicalState::setSpeciesAmount))
        .def("setSpeciesAmount", [](ChemicalState& self, StringOrIndex const& species, double amount, Chars unit) { self.setSpeciesAmount(species, amount, unit); })
        ...
        .def("set", [](ChemicalState& self, StringOrIndex const& species, double value, Chars unit) { self.set(species, value, unit); })
        .def("set", &ChemicalState::set)
        .def("add", [](ChemicalState& self, StringOrIndex const& species, double value, Chars unit) { self.add(species, value, unit); })
