...
void exportEquilibriumConditions(py::module& m)
{
    py::class_<EquilibriumConditions>(m, "EquilibriumConditions")
        ...
        .def("temperature", [](EquilibriumConditions& self, double value, Chars unit) { self.temperature(value, unit); }, "Specify the temperature of the system at chemical equilibrium", py::arg("value"), py::arg("unit")="K")
        ...
        .def("pressure", [](EquilibriumConditions& self, double value, Chars unit) { self.pressure(value, unit); }, "Specify the pressure of the system at chemical equilibrium", py::arg("value"), py::arg("unit")="Pa")
        ...
        .def("fugacity", [](EquilibriumConditions& self, String const& species, double value, Chars unit) { self.fugacity(species, value, unit); }, "Specify the fugacity of a gaseous species at chemical equilibrium", py::arg("species"), py::arg("value"), py::arg("unit")="Pa")
        ...
        .def("pH", [](EquilibriumConditions& self, double value) { self.pH(value); }, "Specify the pH at chemical equilibrium", py::arg("value"))
        ...
        .def("set", [](EquilibriumConditions& self, String const& name, double value) { self.set(name, value); }, "Set the value of an input variable with given name.")
